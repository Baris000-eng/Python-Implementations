...
if(is_Male==True and is_Wearing_Glasses==True):
...
#This is a python program which prints the situations #of being a male and wearing glasses for the #charachter called "Mike". 
